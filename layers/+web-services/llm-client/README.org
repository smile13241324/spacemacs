...
| Key binding  | Command                    | Description                     |
|--------------+----------------------------+---------------------------------|
| ~SPC $ ee c~ | ellama-complete            | Complete text in current buffer |
| ~SPC $ ee w~ | ellama-improve-wording     | Improve wording                 |
| ~SPC $ ee g~ | ellama-improve-grammar     | Improve grammar                 |
| ~SPC $ ee s~ | ellama-improve-conciseness | Shorten text (make concise)     |
| ~SPC $ ee l~ | ellama-make-list           | Create markdown list            |
| ~SPC $ ee t~ | ellama-make-table          | Create markdown table           |
| ~SPC $ ee f~ | ellama-make-format         | Render text as specified format |
